...
if ($db->connect_error) {
    ...
    if (isset($_POST['selected_ids'])) {
        ...
        foreach ($selectedIDs as $id) {
            ...
            $query = "DELETE FROM samu_staff WHERE id='$id'";
            $result = mysqli_query($db, $query);

            if ($result) {
                echo "Staff with ID $id has been removed successfully.<br>";
            } else {
                echo "Error removing staff with ID $id.<br>";
            }
        }
    } else {
